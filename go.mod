module github.com/taigrr/gojev

go 1.27.1

require (
	github.com/taigrr/catwalk v0.52.0-fork
	github.com/taigrr/fantasy v0.28.0-fork
)
...
require (
	...
	github.com/hybridgroup/yzma v1.27.1-0.20260917101309-d48a589de711 // indirect
